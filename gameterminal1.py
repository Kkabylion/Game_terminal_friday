...
while spelar == True:
    ...
    if svar_5 == "x = 1000" or svar_5 == "x = tusen":
        print("Rätt!")
        poäng +=1
    ...
    if svar_7 == "Bolean" or svar_7 == "bolean":
        print("Rätt!")
        poäng +=1
    ...
    if svar_8 == "float" or svar_8 == "Float":
        print("Rätt!")
        poäng +=1
    ...
    print("Gör en enkel uträkning med print på 12 delat på 3 plus fyra minus 1")
    svar_10 = input("Svara här: ")
    if svar_10 == "print(12/3+4-1)":
        print("Rätt!")
        poäng +=1
